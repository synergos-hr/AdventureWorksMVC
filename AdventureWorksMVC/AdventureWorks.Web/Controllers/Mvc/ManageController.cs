...
using AdventureWorks.Web.Models.Account.Manage;
...
namespace AdventureWorks.Web.Controllers.Mvc
{
    ...
    public class ManageController : BaseController
    {
        ...
        {
            string code = await UserManager.GenerateChangePhoneNumberTokenAsync(User.Identity.GetUserId<int>(), phoneNumber);
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                AlertSuccess("Lozinka je promijenjena.", true);
